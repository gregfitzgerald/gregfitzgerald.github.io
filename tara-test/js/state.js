...
export function save() {
  try {
    localStorage.setItem('t4test_edits', JSON.stringify(state.edits));
    localStorage.setItem('t4test_smartDone', JSON.stringify(state.smartDone));
    localStorage.setItem('t4test_asmrDone', JSON.stringify(state.asmrDone));
...
export function load() {
  try {
    const e = localStorage.getItem('t4test_edits');
    if (e) state.edits = JSON.parse(e);
    const sd = localStorage.getItem('t4test_smartDone');
    if (sd) state.smartDone = JSON.parse(sd);
    const ad = localStorage.getItem('t4test_asmrDone');
    if (ad) state.asmrDone = JSON.parse(ad);
    const dt = localStorage.getItem('t4test_dayTasks');
    if (dt) state.dayTasks = JSON.parse(dt);
    const rd = localStorage.getItem('t4test_resetDone');
